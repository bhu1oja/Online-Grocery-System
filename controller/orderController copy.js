...
exports.addOrder = async (req,res) =>{
  ...
  const order = new Order({
    ...
    coupon:couponData != null ? couponData.id : null,
  ...
  order
      ...
      let bulkOption =  result.orderItems.map(item=> {
       ...
       await Product.bulkWrite(bulkOption,{})
        ...
        //send mail
         sendEmail("public/emails/orderConfirmation.ejs",result,process.env.GOOGLE_MAIL_ID,email ,"Order confirmation","Order Confirmation!!!!",res)
